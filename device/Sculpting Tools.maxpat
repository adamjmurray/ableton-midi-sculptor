...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 559.606995000000097, 91.0, 45.0, 22.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 479.315308000000016, 55.0, 60.0, 22.0 ],
					"text" : "select 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 408.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 279.0, 372.0, 63.0, 22.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.0, 442.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 252.0, 342.0, 40.0, 22.0 ],
					"text" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 990.232055999999943, 79.5, 29.5, 22.0 ],
					"text" : "238"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 872.232055999999943, 69.0, 29.5, 22.0 ],
					"text" : "244"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 434.0, 55.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 29.375, 223.0, 198.0 ],
					"proportion" : 0.39,
					"rounded" : 4
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 479.315308000000016, 91.0, 34.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.315308000000016, 10.0, 34.0, 34.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 23.0, 235.0, 210.0 ],
					"proportion" : 0.39
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-8::obj-38::obj-1::obj-5" : [ "live.toggle", "live.toggle", 0 ],
...
,
				"obj-1::obj-11::obj-5::obj-20" : 				{
					"parameter_longname" : "velocity range[6]"
				}
,
