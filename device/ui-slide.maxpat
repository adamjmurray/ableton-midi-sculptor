...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 832.0, 126.5, 77.0, 22.0 ],
					"text" : "route symbol"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 832.0, 88.0, 89.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 469.0, 368.0, 123.0, 22.0 ],
					"text" : "strum_unlock_end $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 560.0, 152.0, 67.0, 22.0 ],
					"text" : "set Spread"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 560.0, 184.0, 49.0, 22.0 ],
					"text" : "set End"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.0, 184.0, 53.0, 22.0 ],
					"text" : "set Start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.0, 152.0, 52.0, 22.0 ],
					"text" : "set Shift"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 142.5, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 142.5, 33.0, 22.0 ],
					"text" : "-150"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 334.0, 110.5, 73.0, 22.0 ],
					"text" : "select strum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 482.0, 463.0, 131.0, 22.0 ],
					"text" : "prepend strum_tension"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 410.5, 368.0, 49.0, 22.0 ],
					"text" : "qlim 15"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.0, 368.0, 49.0, 22.0 ],
					"text" : "qlim 15"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 504.0, 265.5, 60.0, 34.0 ],
					"text" : "TODO: Colors"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 174.5, 64.0, 22.0 ],
					"text" : "offset $1 0"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "float", "" ],
					"patching_rect" : [ 352.0, 216.0, 136.0, 138.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 18.0, 147.0, 141.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1005.0, 395.5, 64.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 706.0, 273.5, 54.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 172.0, 20.0, 47.0, 18.0 ],
					"text" : "Spread",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 606.0, 273.5, 34.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 20.0, 31.0, 18.0 ],
					"text" : "Shift",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 50.0, 389.5, 72.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 146.0, 317.5, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 146.0, 269.5, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 341.5, 29.5, 22.0 ],
					"text" : "1"
				}
...
,
					"patching_rect" : [ 690.0, 209.5, 69.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 463.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 930.0, 419.0, 152.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 100.5, 0.0, 113.0, 21.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 146.0, 30.5, 59.5, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 930.0, 460.0, 120.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 930.0, 332.0, 36.0, 22.0 ],
					"text" : "* -30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 930.0, 372.0, 66.0, 22.0 ],
					"text" : "offset 0 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.5, 463.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 832.0, 352.0, 74.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 770.0, 332.0, 49.0, 22.0 ],
					"text" : "qlim 15"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 770.0, 459.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 770.0, 419.0, 81.0, 22.0 ],
					"text" : "prepend start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 463.0, 130.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 423.5, 81.0, 22.0 ],
					"text" : "prepend start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 419.0, 81.0, 22.0 ],
					"text" : "prepend start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 459.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 560.0, 74.0, 22.0 ],
					"text" : "s ---sculptor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 666.0, 103.0, 79.0, 22.0 ],
					"text" : "r ---mouseup"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 642.0, 148.5, 24.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 770.0, 217.5, 37.0, 22.0 ],
					"text" : "set 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 217.5, 37.0, 22.0 ],
					"text" : "set 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 930.0, 48.0, 131.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 64.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_annotation_name" : "Note Property",
							"parameter_enum" : [ "Start Time", "Pitch", "Velocity", "Duration", "Vel. Range", "Release", "Probability", "Strum" ],
							"parameter_invisible" : 2,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 770.0, 257.5, 31.749328999999999, 50.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 642.0, 257.5, 33.749329000000003, 50.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"color" : [ 0.67451, 0.819608, 0.572549, 1.0 ],
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 155.5, 63.5, 651.5, 63.5 ],
					"order" : 0,
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-11::obj-24" : [ "pitchrange[1]", "pitchrange", 0 ],
			"obj-11::obj-25" : [ "pitchrange[2]", "pitchrange", 0 ],
			"obj-11::obj-26" : [ "pitchrange[3]", "pitchrange", 0 ],
			...
			"obj-38::obj-1::obj-5" : [ "live.toggle[1]", "live.toggle", 0 ],
